        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId1 = table.Column<long>(type: "bigint", nullable: true, defaultValueSql: "0"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    InvoiceId = table.Column<long>(type: "bigint", nullable: false, defaultValueSql: "0"),
                    InvoiceItemId = table.Column<long>(type: "bigint", nullable: false, defaultValueSql: "0"),
                    CustomerId = table.Column<long>(type: "bigint", nullable: false, defaultValueSql: "0"),
                    ProductId = table.Column<long>(type: "bigint", nullable: false, defaultValueSql: "0"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, 0, "5ddde673-cdf0-4bec-b0e8-715c6a7af341", 0L, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "admin@localhost.com", true, null, false, null, "ADMIN@LOCALHOST.COM", "ADMIN@LOCALHOST.COM", "AQAAAAIAAYagAAAAED8fCTrkBcCoMPL7qDeH5i7LVWZcMdrJ6W3BVd/64j1fnjBmxuyNZw9+QmhL/Bs5Yw==", null, false, "f685e11b-acf5-46b8-bc58-187eb01c9c59", false, null, null, "admin@localhost.com" });
